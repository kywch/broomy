...
export default function Terminal({ sessionId, cwd, command, env, isAgentTerminal = false, isActive = false, isolated, isolationMode, dockerImage, repoRootDir }: TerminalProps) {
